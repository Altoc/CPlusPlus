...
//std::cerr<<"inserting 4, 40"<<std::endl;
   myHash.insert(pair<int,int>(4, 40));
//std::cerr<<"inserting 6, 60"<<std::endl;
...
//std::cerr<<"inserting 4, 35"<<std::endl;   
   myHash[4] = 35;
//std::cerr<<"inserting 4, 60"<<std::endl;
   myHash[4] = 60;

   auto x3 = myHash.find(4);
   if (x3 != nullptr)
      std::cerr << "4 maps to " << x3->second << endl;
   else 
      cout << "cannot find 4 in map" << endl;
